  ...
  function renderMainContent() {
    switch (activeTab) {
      ...
      case "dashboard":
        return <TradingChart />
      case "analysis":
        return <div className="flex-1 p-4 overflow-auto"><AnalysisPanel /></div>
      case "scanner":
        return <ScannerPanel />
      case "watchlist":
      ...
      case "news":
        return <div className="flex-1 overflow-auto"><NewsPanel /></div>
      case "admin":
    ...
    <div className="h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <div className={cn("flex-1 flex flex-col min-w-0", showRight ? "" : "w-full")}>
          ...
          {activeTab === "analysis" && (
            <div className="flex-1 p-4 overflow-auto"><AnalysisPanel /></div>
          )}
